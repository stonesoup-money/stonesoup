/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d5baf729eacb5ed13b774c5d56fe8c88)
...
interface __BaseEnv_Env {
	...
	DAILY_REVIEW_CAP: "200";
	REVIEW_QUEUE_CAP: "100";
	REVIEW_QUEUE_REFILL_AT: "20";
	GOLDEN_SET_CONTRIBUTION: "on";
	DEPLOYMENT_MODE: "self-hosted";
	OPERATOR_NAME: "[[LEGAL_ENTITY — a human must fill this in before this instance serves a hosted user — see docs/privacy-claims.md]]";
	OPERATOR_CONTACT: "[[CONTACT_ADDRESS — a human must fill this in before this instance serves a hosted user — see docs/privacy-claims.md]]";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./packages/worker/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_MODEL" | "TAXONOMY_VERSION" | "BACKFILL_WINDOW_DAYS" | "SAMPLING_RATE" | "CONFIDENCE_FLOOR" | "DAILY_REVIEW_CAP" | "REVIEW_QUEUE_CAP" | "REVIEW_QUEUE_REFILL_AT" | "GOLDEN_SET_CONTRIBUTION" | "DEPLOYMENT_MODE" | "OPERATOR_NAME" | "OPERATOR_CONTACT">> {}
}
